...
namespace ScheduX.UI.PeriodOfStudy
{
    ...
    public partial class PeriodOfStudyWindow : Window
    {
        ...
        private void Select_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                (Owner as EditorWindow).HomePage.PeriodIndicator.Fill = ColorPalette.GetPredefinedColor(PredefinedColors.Green);
                this.Close();
            }
            else
            {
        ...
        {
            if (StudyPeriodDict.dictionaryList.Count.Equals(0) | PeriodsList.SelectedItem == null)
            {
